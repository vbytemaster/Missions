...
function func_scouts()
	do
		RunMultiSpawn(msd_vars.a1, "scouts")
		RunMultiSpawn(msd_vars.a2, "scouts")
	end
end
...
function func_define_flags()
	...
	do
		...
		AIparts:AddOneTime(AIparts:GetUniqueId("TIMER_DO_"), 60*10, function()  SetCountdownObjectives({"West Flag","East Flag","Central Flag1","Central Flag2","South Flag","North Flag", }) end)
	end
	do
